...
import type { BarcodeResponse, ApiError } from "@/lib/api-types";
import { isValidBarcode } from "@/lib/api-types";
 ...
 * 스캐너 페이지에서 사용
 */
export async function GET(request: NextRequest): Promise<NextResponse<BarcodeResponse | ApiError>> {
