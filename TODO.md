...
> 작업 목록. 완료 시 `[x]`로 체크. 최종 업데이트: 2026-02-25
...
- [ ] 스트릭 + 배지 시스템: 연속 체크일 수 배지 (3/7/14/30일)
- [ ] 성분 알레르기 알림: "피해야 할 성분" 등록 → 분석 시 자동 경고
- [ ] 계절 전환 루틴 가이드
- [ ] 프리미엄 구독 (월 3,900원): AI 성분 무제한 + 실시간 날씨 + 개인화 리포트

### Phase 5: 소셜 + 바이럴
- [ ] "루틴 따라하기" 확장: 부족 제품 추천 + 듀프 자동 제시
- [ ] 루틴 챌린지 확장: 21일/30일 + 주제별 (미백/트러블/안티에이징)
- [ ] 팔로우/팔로워 + 피드 맞춤화
